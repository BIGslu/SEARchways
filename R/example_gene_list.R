#' Example gene log2 fold change (FC) list
#'
#' @format A list of 2 vectors with 100 elements.
#' \describe{
#'   \item{HRV1}{numeric. Log2 FC of 100 random genes. Names are ENSEMBL ID.}
#'   \item{HRV2}{numeric. Log2 FC of 100 random genes. Names are ENSEMBL ID.}
#'       }
#'
